...
const I18N = {
  ...
  DE:{
    ...
    harmony:'Auto', spectral:'Hell', phi:'Kräftig', kontra:'Kontrast', custom:'eigen', bw:'s/w', pickLook:'Wähle einen Look', editSet:'Set bearbeiten', editHint:'Tippe zum Hinzufügen oder Entfernen.', editFull:'Alle verwalten →', setupPickerLabel:'Stile & Paletten', setupPickerHint:'wähle, welche Paletten und Künstler in den Canvas-Wählern erscheinen', setupPalettesTitle:'Paletten', setupArtistsTitle:'Künstler', setupMosaicFamily:'Mosaik-Familie', setupSave:'Fertig', setupMinError:'Wähle mindestens 1 Palette und 1 Künstler.', setupAll:'Alle', setupNone:'Keine', gcat_all:'Alle', gcat_start:'Start', gcat_colors:'Farben', gcat_style:'Stil', gcat_music:'Musik', gcat_tools:'Werkzeuge', gcat_save:'Sichern', gcat_pro:'Pro', gcat_book:'Buch', guideMore:'Mehr', guideLess:'Weniger', proLockTitle:'Pro', customize:'Anpassen', basicMode:'Einfach', advancedMode:'Erweitert', hideControls:'Steuerung ausblenden', tryThis:'Probier das', yourPainting:'Dein Gemälde', surpriseMe:'Überrasch mich', useMySong:'Mein Song', tryAnother:'Noch eins', saveLabel:'Sichern', shareLabel:'Teilen',
  ...
  SK:{
    ...
    harmony:'Auto', spectral:'Jasné', phi:'Výrazné', kontra:'Kontrast', custom:'vlastná', bw:'č/b', pickLook:'Vyber vzhľad', editSet:'Uprav si zostavu', editHint:'Ťukni pre pridanie alebo odobranie.', editFull:'Spravovať všetko →', setupPickerLabel:'Štýly a palety', setupPickerHint:'vyber palety a umelcov, ktorí sa zobrazia v canvas selektoroch', setupPalettesTitle:'Palety', setupArtistsTitle:'Umelci', setupMosaicFamily:'Mosaic rodina', setupSave:'Hotovo', setupMinError:'Vyber aspoň 1 paletu a 1 umelca.', setupAll:'Všetko', setupNone:'Nič', gcat_all:'Všetko', gcat_start:'Začni', gcat_colors:'Farby', gcat_style:'Štýl', gcat_music:'Hudba', gcat_tools:'Nástroje', gcat_save:'Ulož', gcat_pro:'Pro', gcat_book:'Kniha', guideMore:'Viac', guideLess:'Menej', proLockTitle:'Pro', customize:'Upraviť', basicMode:'Základný', advancedMode:'Pokročilý', hideControls:'Skryť ovládanie', tryThis:'Vyskúšaj', yourPainting:'Tvoj obraz', surpriseMe:'Prekvap ma', useMySong:'Moja skladba', tryAnother:'Ďalší', saveLabel:'Ulož', shareLabel:'Zdieľať',
  ...
  zh:{
    ...
    harmony:'自动', spectral:'明亮', phi:'浓烈', kontra:'对比', custom:'自定义', bw:'黑白', pickLook:'选个风格', editSet:'编辑你的组合', editHint:'点按以添加或移除。', editFull:'管理全部 →', setupPickerLabel:'风格与调色板', setupPickerHint:'选择哪些调色板和艺术家出现在画布选择器中', setupPalettesTitle:'调色板', setupArtistsTitle:'艺术家', setupMosaicFamily:'Mosaic 家族', setupSave:'完成', setupMinError:'至少选择 1 个调色板和 1 位艺术家。', setupAll:'全部', setupNone:'无', gcat_all:'全部', gcat_start:'开始', gcat_colors:'颜色', gcat_style:'风格', gcat_music:'音乐', gcat_tools:'工具', gcat_save:'保存', gcat_pro:'Pro', gcat_book:'书', guideMore:'更多', guideLess:'收起', proLockTitle:'Pro', customize:'自定义', basicMode:'基础', advancedMode:'高级', hideControls:'隐藏控件', tryThis:'试试这个', yourPainting:'你的画作', surpriseMe:'给我惊喜', useMySong:'用我的歌', tryAnother:'再来一幅', saveLabel:'保存', shareLabel:'分享',
  ...
  zhTW:{
    ...
    harmony:'自動', spectral:'明亮', phi:'濃烈', kontra:'對比', custom:'自訂', bw:'黑白', pickLook:'選個風格', editSet:'編輯你的組合', editHint:'點按以新增或移除。', editFull:'管理全部 →', setupPickerLabel:'風格與調色盤', setupPickerHint:'選擇哪些調色盤和藝術家出現在畫布選擇器中', setupPalettesTitle:'調色盤', setupArtistsTitle:'藝術家', setupMosaicFamily:'Mosaic 家族', setupSave:'完成', setupMinError:'至少選擇 1 個調色盤和 1 位藝術家。', setupAll:'全部', setupNone:'無', gcat_all:'全部', gcat_start:'開始', gcat_colors:'顏色', gcat_style:'風格', gcat_music:'音樂', gcat_tools:'工具', gcat_save:'儲存', next:'下一個', showLabel:'放映', gcat_pro:'Pro', gcat_book:'書', guideMore:'更多', guideLess:'收起', proLockTitle:'Pro', customize:'自訂', basicMode:'基礎', advancedMode:'進階', hideControls:'隱藏控制項', tryThis:'試試這個', yourPainting:'你的畫作', surpriseMe:'給我驚喜', useMySong:'用我的歌', tryAnother:'再來一幅', saveLabel:'儲存', shareLabel:'分享',
  ...
  PT:{
    ...
    harmony:'Auto', spectral:'Vivo', phi:'Intenso', kontra:'Contraste', custom:'personalizada', bw:'p&b', pickLook:'Escolhe um estilo', editSet:'Editar o teu conjunto', editHint:'Toca para adicionar ou remover.', editFull:'Gerir tudo →', setupPickerLabel:'Estilos e paletas', setupPickerHint:'escolhe que paletas e artistas aparecem nos seletores da tela', setupPalettesTitle:'Paletas', setupArtistsTitle:'Artistas', setupMosaicFamily:'Família Mosaico', setupSave:'Pronto', setupMinError:'Escolhe pelo menos 1 paleta e 1 artista.', setupAll:'Tudo', setupNone:'Nenhum', gcat_all:'Tudo', gcat_start:'Início', gcat_colors:'Cores', gcat_style:'Estilo', gcat_music:'Música', gcat_tools:'Ferramentas', gcat_save:'Guardar', gcat_pro:'Pro', gcat_book:'Livro', guideMore:'Mais', guideLess:'Menos', proLockTitle:'Pro', customize:'Personalizar', basicMode:'Básico', advancedMode:'Avançado', hideControls:'Ocultar controlos', tryThis:'Experimenta', yourPainting:'A tua pintura', surpriseMe:'Surpreende-me', useMySong:'A minha música', tryAnother:'Outra', saveLabel:'Guardar', shareLabel:'Partilhar',
  ...
  ja:{
    ...
    harmony:'オート', spectral:'ブライト', phi:'ボールド', kontra:'コントラスト', custom:'カスタム', bw:'白黒', pickLook:'ルックを選ぶ', editSet:'セットを編集', editHint:'タップで追加・削除。', editFull:'すべて管理 →', setupPickerLabel:'スタイルとパレット', setupPickerHint:'キャンバスのピッカーに出すパレットとアーティストを選ぶ', setupPalettesTitle:'パレット', setupArtistsTitle:'アーティスト', setupMosaicFamily:'Mosaic ファミリー', setupSave:'完了', setupMinError:'最低 1 パレット + 1 アーティストを選んでください。', setupAll:'すべて', setupNone:'なし', gcat_all:'すべて', gcat_start:'はじめ', gcat_colors:'色', gcat_style:'スタイル', gcat_music:'音楽', gcat_tools:'ツール', gcat_save:'保存', gcat_pro:'Pro', gcat_book:'本', guideMore:'もっと', guideLess:'閉じる', proLockTitle:'Pro', customize:'カスタマイズ', basicMode:'ベーシック', advancedMode:'アドバンス', hideControls:'コントロールを隠す', tryThis:'試してみて', yourPainting:'あなたの絵', surpriseMe:'おまかせ', useMySong:'自分の曲', tryAnother:'もう一枚', saveLabel:'保存', shareLabel:'共有',
