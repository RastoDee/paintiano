...
const I18N = {
  ...
  DE:{
    ...
    proPaywallSubtitle:'Einmal zahlen. Für immer behalten.',
    proSupportLine:'Du hältst damit auch ein unabhängiges Solo-Kunstprojekt am Leben.',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'9,99 € · early-bird (danach 14,99 €)',
    proValueArtists:'18 Künstler (Free hat 9)',
    proValueTypes:'6 Mal-Typen pro Künstler (Free hat 2)',
    proValuePalette:'Eigene Palette — 12 Farben nach Wahl',
    proValueDpi:'300-DPI-Export, kein Wasserzeichen',
    proValueLife:'Lebenslanger Zugang',
    proGetCta:'Pro holen',
    proAiTierTitle:'Paintiano Pro KI',
    proAiTierPrice:'19,99 € · early-bird (danach 24,99 €)',
    proAiValueAll:'Alles aus Pro, plus:',
    proAiValueText:'KI-Komposition aus Text-Stimmungen',
    proAiValueImage:'KI-Komposition aus deinen Bildern',
    proAiValueAtmo:'KI-atmosphärische Färbung',
  ...
  FR:{
    ...
    proPaywallSubtitle:'Payer une fois. Garder pour toujours.',
    proSupportLine:'Vous soutenez aussi un projet d’art solo indépendant.',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'9,99 € · early-bird (puis 14,99 €)',
    proValueArtists:'18 artistes (Free en a 9)',
    proValueTypes:'6 types de peinture par artiste (Free en a 2)',
    proValuePalette:'Palette personnalisée — vos 12 couleurs',
    proValueDpi:'Exports 300 DPI, sans filigrane',
    proValueLife:'Accès à vie',
    ...
    proAiValueText:'Composition IA depuis des ambiances texte',
    proAiValueImage:'Composition IA depuis vos images',
    proAiValueAtmo:'Coloration atmosphérique par IA',
  ...
  ES:{
    ...
    proPaywallSubtitle:'Paga una vez. Guarda para siempre.',
    proSupportLine:'También mantienes vivo un proyecto artístico independiente.',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'9,99 € · early-bird (luego 14,99 €)',
    proValueArtists:'18 artistas (Free tiene 9)',
    proValueTypes:'6 tipos de pintura por artista (Free tiene 2)',
    proValuePalette:'Paleta personalizada — 12 colores tuyos',
    proValueDpi:'Exportaciones a 300 DPI, sin marca de agua',
    proValueLife:'Acceso de por vida',
    proGetCta:'Obtener Pro',
    proAiTierTitle:'Paintiano Pro IA',
    proAiTierPrice:'19,99 € · early-bird (luego 24,99 €)',
    proAiValueAll:'Todo en Pro, además:',
    proAiValueText:'Composición de IA desde moods de texto',
    proAiValueImage:'Composición de IA desde tus imágenes',
    proAiValueAtmo:'Coloración atmosférica con IA',
  ...
  SK:{
    ...
    proPaywallSubtitle:'Zaplať raz. Maj navždy.',
    proSupportLine:'Zároveň pomáhaš udržať nezávislý umelecký projekt.',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'9,99 € · early-bird (potom 14,99 €)',
    proValueArtists:'18 umelcov (Free má 9)',
    proValueTypes:'6 typov maľby na umelca (Free má 2)',
    proValuePalette:'Vlastná paleta — nastav si 12 farieb',
    proValueDpi:'300 DPI exporty, bez vodoznaku',
    proValueLife:'Doživotný prístup',
    proGetCta:'Získať Pro',
    proAiTierTitle:'Paintiano Pro AI',
    proAiTierPrice:'19,99 € · early-bird (potom 24,99 €)',
    proAiValueAll:'Všetko z Pro, plus:',
    proAiValueText:'AI kompozícia z textových moodov',
    proAiValueImage:'AI kompozícia z tvojich obrázkov',
    proAiValueAtmo:'AI atmosférické tónovanie',
  ...
  zh:{
    ...
    proPaywallSubtitle:'一次付款。永久使用。',
    proSupportLine:'您也在帮助一个独立的艺术项目持续运作。',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'€9.99 · 早鸟价(之后 €14.99)',
    proValueArtists:'18 位艺术家(免费版 9 位)',
    proValueTypes:'每位艺术家 6 种画法(免费版 2 种)',
    proValuePalette:'自定义调色板 — 12 种你的颜色',
    proValueDpi:'300 DPI 导出,无水印',
    proValueLife:'终身访问',
    proGetCta:'获取 Pro',
    proAiTierTitle:'Paintiano Pro AI',
    proAiTierPrice:'€19.99 · 早鸟价(之后 €24.99)',
    proAiValueAll:'Pro 中的所有功能,另外:',
    proAiValueText:'从文字情绪 AI 作曲',
    proAiValueImage:'从您的图片 AI 作曲',
    proAiValueAtmo:'AI 氛围色彩',
  ...
  zhTW:{
    ...
    proAiBadge:'PRO AI',
    mfiRecent:'最近',
    proPaywallTitle:'解鎖完整的 Paintiano',
    proPaywallTitleAi:'您已用完免費的 AI 作曲次數',
    ...
    proValueArtists:'18 位藝術家（免費版 9 位）',
    proValueTypes:'每位藝術家 6 種畫法（免費版 2 種）',
    proValuePalette:'自訂調色盤 — 12 種您的顏色',
    proValueDpi:'300 DPI 匯出，無浮水印',
    proValueLife:'終身存取',
    proGetCta:'取得 Pro',
    proAiTierTitle:'Paintiano Pro AI',
    proAiTierPrice:'€19.99 · 早鳥價（之後 €24.99）',
    proAiValueAll:'Pro 中的所有功能，另外：',
    proAiValueText:'從文字情緒 AI 作曲',
    proAiValueImage:'從您的圖片 AI 作曲',
    proAiValueAtmo:'AI 氛圍色彩',
  ...
  PT:{
    ...
    proPaywallSubtitle:'Pague uma vez. Mantenha para sempre.',
    proSupportLine:'Você também ajuda a manter um projeto de arte solo independente.',
    proTierTitle:'Paintiano Pro',
    proTierPrice:'€9.99 · early-bird (depois €14.99)',
    proValueArtists:'18 artistas (Free tem 9)',
    proValueTypes:'6 tipos de pintura por artista (Free tem 2)',
    proValuePalette:'Paleta personalizada — 12 cores suas',
    proValueDpi:'Exportações 300 DPI, sem marca d\'água',
    proValueLife:'Acesso vitalício',
    proGetCta:'Obter Pro',
    proAiTierTitle:'Paintiano Pro IA',
    proAiTierPrice:'€19.99 · early-bird (depois €24.99)',
    proAiValueAll:'Tudo do Pro, mais:',
    proAiValueText:'Composição IA a partir de moods de texto',
    proAiValueImage:'Composição IA a partir das suas imagens',
    proAiValueAtmo:'Coloração atmosférica por IA',
  ...
  ja:{
    ...
    proValueArtists:'18 人のアーティスト(Free は 9 人)',
